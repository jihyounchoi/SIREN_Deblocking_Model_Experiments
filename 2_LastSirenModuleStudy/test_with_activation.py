...
ckpt_dir = "model_zoo/omega10_1000.pth"
# ckpt_dir = "model_zoo/omega10_1000.pth"
# ckpt_dir = "model_zoo/omega50_1000.pth"

activation_string = "R,R,R/R,R,R/R,R,R/R,R,R/R,R,R/S,S,S"
omega_string = "1/1/1/1/1/10"
residual_string = "F/T/T/T/T/F"

model = CustomNetwork(activation_string=activation_string, omega_string = omega_string, residual_string=residual_string, global_skip=False, tracking_point_list=['siren_1', 'siren_2', 'siren_3'])

ckpt_name = os.path.basename(ckpt_dir)
model_name = os.path.splitext(ckpt_name)[0]
base_dir = os.path.join(base_dir, model_name)

dataset_test = DatasetJPEG(edge_aware = False, patch_size=0, dataset_path=datadir_test, phase='test', qf_candidates=qf_candidates)
